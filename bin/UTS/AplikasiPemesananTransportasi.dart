...
void main() {
  ...
  var taksi = Taksi("T01", "Taksi Ekspress", 10000, 4, 12.5);
  var bus = Bus("B01", "Bus Halsel", 6000, 50, true);
  var pesawat = Pesawat("P01", "Lion Air", 1700000, 200, "Bisnis");

  // Membuat daftar pemesanan
  List<Pemesanan> daftar = [];
  daftar.add(buatPemesanan(taksi, "Dea", 1, "PSN01"));
  daftar.add(buatPemesanan(bus, "Eyy", 8, "PSN02"));
  daftar.add(buatPemesanan(pesawat, "Reva", 2, "PSN03"));
